...
Auf $X\da K^{n+1}\smallsetminus\{0\}$ operiert die Gruppe $K^\times$ durch
...
$$d_p(x,y) \da\left\{\begin{array}{rl}
0, & {\rm falls}\ x=y,\\
...
Vereinigung
$$\stackrel\circ A \da \bigcup_{U\subseteq_o A} U,$$
...
$\partial A\da\bar A\smallsetminus \stackrel\circ A.$
