...
W'keit, bei $m$ Versuchen ohne Zur¸cklegen von $n$ s/w-Kugeln $k$ der $r$ weiﬂen zu ziehen.\\
...
\h{Grenzwerts‰tze}
\hh{Kolmogorov}
(Starkes Gesetz der groﬂen Zahlen)\\
...
$\varphi : \chi^n \rightarrow \{1,0\}$ heiﬂt \hhh{Test} \\
...
\\
%\vfill
\tiny Dieses Blatt ist ein \url{http://mitschriebwiki.nomeata.de/}-Projekt.\\ Letze ƒnderung: \svnInfoLongDate{} \svnInfoTime
\end{center}
\end{document}
