...
\begin{enumerate}
\item\label{1.4.1a} Seien $V\subseteq k^{n}, W\subseteq k^{m}$ affine Varietäten. Eine Abbildung $f\colon V\mapsto W$ heißt Morphismus, wenn es Polynome $f_1,\dotsc,f_m \in k\polyx$ mit 
\[f(p)=(f_1(p),\dotsc,f_m(p)) \in k^{m}\]
gibt.
\item\label{1.4.1b} Ein Morphismus $f\colon V\mapsto W$ heißt Isomorphismus, wenn es einen Morphismus $g\colon W\mapsto V$ mit $g\circ f=\id_V, f\circ g=\id_W$ gibt.
...
\begin{enumerate}
\item Jeder Morphismus $f\colon V\ra W$ induziert wie folgt einen k-Algebrenhomomorphismus:  
...
Definiere den Homomorphismus $\phi\colon  K\polyx\ra A$ durch $X_i\mapsto a_i$. Aus der Reduziertheit von $A$ folgt, dass $I=\Kern(\phi)$ ein Radikalideal ist. Setze nun $V=\ V(I)$. Da $K$ algebraisch abgeschlossen ist, gilt $\I(V)=\sqrt{(I)}=I$.Insgesamt:
