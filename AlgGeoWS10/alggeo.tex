...
\begin{w}
Im Allgemeinen gibt es viel mehr stetige Abbildungen als Morphismen, so ist beispielsweise jede bijektive Abbildung von $k$ nach $k$ stetig nach \cref{1.2.4}.
\end{w}
