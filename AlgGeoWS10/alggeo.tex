...
\begin{dfn}\label{1.5.3}
  ...
  \begin{enumerate}
  \item\Label{1.5.3a} Sei $p\in U$. Eine Funktion $r\colon U\ra\A^1(K)$ heißt \emph{regulär in $p$}, wenn es eine Umgebung $U_p$ von $p$ gibt
    und $f_p,g_p\in K[V]$ mit $g_p(x)\neq0$ für alle $x\in U_p$, sodass\[r(x)=\frac{f_p(x)}{g_p(x)}\text{ für alle }x\in U_p\text{ gilt.}\] Die Funktion $r$ heißt \emph{regulär}, wenn sie für alle $p\in U$ regulär ist.
...
\begin{db}\label{1.5.14}
  ...
  \item\Label{1.5.14ii} Eine Abbildung $f\colon W_1\ra W_2$ zwischen quasi-affinen Varietäten heißt \emph{Morphismus} oder \emph{reguläre Abbildung}, wenn $f$
...
Sei $(U,r)$ mit $r\in \O(U)$ rationale Funktion. Da $r$ regulär gibt es $U'\subseteq U$ mit $r\restrict{U'}=\frac{g}{h}$, wobei
