...
\newcommand{\definetheorem}[3]{
  ...
  \BeforeBeginEnvironment{#1}{\makeatletter%
     ...
     \edef\labelcode{ctr@#1@\roman{chapter}@\roman{section}@\arabic{thmcnt}}%
    ...
    %\immediate\write\blah{\string\creflabelformat{\labelcode}{\detokenize\expandafter{\@hashsign\relax}}}\endgroup%
