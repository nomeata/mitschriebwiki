...
\node[right,text width=\textwidth,fill=blue,inner sep=1ex]{%
  \hbox{%
  \begin{minipage}[c]{.85\textwidth}\smallskip\section{#1}\medskip\end{minipage}%
  \makebox[\width][t]{\raisebox{1.3ex}{X}}%
}};\end{tikzpicture}}
