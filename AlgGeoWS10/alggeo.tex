...
\begin{proof}
\begin{enumerate}
  \item[\ref{3.5.4a}] Sei zuerst $ \{\m_1,\dotsc,\m_n\} =\m$. Betrachte die Projektionen $\pi_1\colon R\ra k=\Quotient{R}{\m}$, $\pi_2\colon \m\ra \Quotient{\m}{\m^2}$. Dann ist $\Bar{rm_1}:=\pi_1(r)\pi_2(m)$ wohldefiniert und $\{\Bar{\m_1},\dotsc,\Bar{\m_n}\}$ ist ein Erzeugendensystem von $\Quotient{\m}{\m^2}$.

  Sei jetzt $\{\Bar{\m_1},\dotsc,\Bar{\m_n}\}=\Quotient{\m}{\m^2}$. Definiere $N=<\m_1,\dotsc,m_n>$. Dann ist $\m=N+\m^2$ und damit $N=\m$ nach dem Nakayama-Lemma aus Algebra 2.
