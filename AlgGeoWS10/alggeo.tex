...
\begin{enumerate}
\item\Label{1.4.1a} Seien $V\subseteq k^{n}, W\subseteq k^{m}$ affine Varietäten. Wir nennen eine Abbildung $f\colon V\ra W$ Morphismus, wenn es Polynome $f_1,\dotsc,f_m \in k\polyx$ mit 
\[f(p)=(f_1(p),\dotsc,f_m(p)) \in k^{m}\text{ gibt.}\]
\item\Label{1.4.1b} Ein Morphismus $f\colon V\ra W$ heißt Isomorphismus, wenn es einen Morphismus $g\colon W\ra V$ mit $g\circ f=\id_V$ und $f\circ g=\id_W$ gibt.
