...
\begin{enumerate}
  \item (Krullsches Hauptideallemma, vgl. Brodmann, 3.10.15)
  
   Ist $R$ noetherscher Ring, $x\in R\setminus R^{\times}$, $\wp$ minimales Primoberideal von $(x)$, dann gilt $\hoehe \wp \le 1$.
  \item Jeder noetherscher Ring hat nur endlich viele minimale Primideale (vgl. auch Satz 1, Brodmann 3, 9.17 (iii)).
  \item (Primidealvermeidungslemma, vgl. Brodmann, 3.11.10)
