...
Es gibt eine trennende Hyperebene, wenn $E \notin \convo(P_1^t, \ldots, P_N^t)$, wobei $\convo$ das Innere der konvexen H"ulle bezeichnet, und dann ist ein Entkommen m"oglich.
...
Die idee hinter dem \Planes Algorithmus ist den Bereich um die Verfolger durch Hyperebenen einzugrenzen und systematisch zu verkleinern.
\begin{center}\begin{tikzpicture}[font=\scriptsize,scale=1]
	%\tikzgitter{(-4,-4)}{(5,4)}
...
\begin{emptythm}[Modifikation: \Spheres]
Wir betrachten das \textsc{Lion and Man} Problem: ein Mensch versucht einem L"owen zu entkommen.
