...
\begin{definition}
	...
	\begin{displaymath}
		...
		\end{pmatrix}
	\end{displaymath}
	Sei $(u_0,v_0)\in B$, $\gamma(t) := \phi(t,v_0)$, $\gamma'(t) = \phi_u(t,v_0)$, $\gamma'(u_0) = \phi_u(u_0,v_0)$. Weiter sei $\tilde{\gamma}(t):= \phi(u_0,t)$, $\tilde{\gamma}'(t) := \phi_v(u_0,v)$, $\tilde{\gamma}'(v_0) = \phi_v(u_0,v_o)$.$N(u_0,v_0) := \phi_u(u_0,v_0)\times\phi_v(u_0,v_0)$ \begriff{Normalenvektor} in $\phi(u_0,v_0)$. \\
