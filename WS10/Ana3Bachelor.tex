...
\begin{satz}
Es seien $\ce_1,\ce_1,\ce_3$ wie folgt definiert:
\begin{align*}
...
\end{align*}
Dann gilt:
\[\fb=\sigma(\ce_1)=\sigma(\ce_2)=\sigma(\ce_3)\]
...
\[G\in\sigma(\ce_1)\implies \fb=\sigma(\co(\mdr^d))\subseteq\sigma(\ce_1)\]
\item Sei $(a,b)\in\ce_1$.\\
\textbf{Fall 1:} $(a,b)=\emptyset\in\ce_2\subseteq(\ce_2)$\\
