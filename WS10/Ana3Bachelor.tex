...
\begin{definition}
$f$ hei�t (Borel-)\textbf{messbar}, genau dann wenn gilt: $f$ ist $\fb_d$-$\fb_2$-messbar.
\end{definition}

Aus 3.2 folgt: $f$ ist messbar genau dann, wenn $u$ und $v$ messbar sind.

\begin{definition}
Sei $f$ messbar. $f$ hei�t \textbf{integrierbar} (ib.) genau dann, wenn $u$ und $v$ integrierbar sind.
...
\[ \cn := \{ f: X \to \MdC | f \text{ ist messbar und } f = 0 \text{ f.�.} \} \]
...
\begin{definition}
F�r $f,g \in L^2(X,\MdC )$ setze $(f | g) := \int_X f(x) \overline{g(x)} \text{ d}x$ sowie $f \bot g :\Longleftrightarrow (f | g) = 0$ ($f$ und $g$ hei�en dann \textbf{orthogonal} zueinander). 
\end{definition}
