...
\begin{beweis}
\begin{enumerate}
 \item Aus \ref{Satz 4.11}(7) folgt: $f$ ist integrierbar �ber $A$ und �ber $B$. Es ist 
...
\int_X \left(\mathds{1}_A f + \mathds{1}_B f \right)(x) \text{ d}x \stackrel{4.11(2)}{=} \int_X \mathds{1}_A f \text{ d}x + \int_X \mathds{1}_B f \text{ d}x \stackrel{4.11(7)}{=} \int_A f \text{ d}x + \int_B f \text{ d}x.\]
 ...
 \item $K$ ist kompakt, also gilt: $\lambda(K) < \infty$. Aus 3.2(1) folgt dann, dass $f$ messbar ist. Analysis II ("stetige Funktionen auf kompakten Mengen nehmen Minimum und Maximum an") liefert: $f$ ist beschr�nkt; und mit 4.11(8) folgt schlie�lich: $f \in \fl^1(K)$.
\end{enumerate}
\end{beweis}
