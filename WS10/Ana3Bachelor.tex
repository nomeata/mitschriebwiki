...
\begin{enumerate}
 ...
 \item Sei $Y \in \fb(X)$, $Y ¸neq \emptyset$. Dann sind die Funktionen $\f|_Y: Y \to \imdr$ und $\mathds{1}_Y\cdot f: X \to \imdr$ integrierbar und
\[\int_Y f(x) \textbf{ d}x := \int_Y f|_Y (x) \textbf{ d}x = \lvert \int_X(\mathds{1}_Y \cdot f)(x) \textbf{ d}x\]
