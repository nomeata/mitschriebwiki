...
\end{align*}
AI $\folgt$ $S_n\to\text{R-}\int_a^bf(x)\,dx$ ($n\to\infty$). 
...
\begin{beispiel}
\begin{enumerate}
\item $X=(0,1]$, $f(x)=\frac{1}{\sqrt{x}}$. AI $\implies$ R-$\int^1_0\frac{1}{\sqrt{x}}\,dx$ ist (absolut) konvergent. Also: $f\in\mathfrak{L}^1(X)$.\\
AI $\implies$ R-$\int_0^1\frac{1}{x}$ ist divergent. Also: $f^2\notin\mathfrak{L}^1(X)$.
