...
\item Definiere $g_n:=|f|+\mathds{1}_{X\setminus \tilde N}g-\mathds{1}_{X\setminus \tilde N}|f_n-f|$. Es ist fsat überall
\begin{align*}
...
\item Es gilt:
\begin{align*}
\int_X(|f|+g)\text{ d}x&\stackrel{\ref{Satz 6.1}(2)}\le \liminf_{n\to\infty} \int_X g_n \text{ d}x\\
