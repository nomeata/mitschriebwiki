...
Zwei Funktionen $f,g:M \to \MdR$, die auf offenen Umgebungen von $p\in M$ differenzierbar sind, heißen äquivalent, falls sie auf einer Umgebung übereinstimmen. Die Äquivalenzklassen heißen Funktionskeime in $p\in M$. Die Menge aller Funktionskeime in $p$ schrieben wir als $C^\infty(p)$.\index{Funktionskeim}
\end{definition}
