...
&= w(g \circ \varphi) \\
&\gleichnach{Lemma 2} w\bigl( g(0) + \sum_{j=1}^m (u^j\varphi \circ)\cdot(g_j \circ \varphi ) \bigr) \\
...
$ d\Phi_p : T_pM \to T_{\Phi(p)}N $ mit $d\Phi_p(v) : C^\infty(\Psi(p)) \to \MdR$ gegeben durch
