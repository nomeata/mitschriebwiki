...
Ein Segment \gamma\right|_{[a,b]} einer Geodätischen \gamma : I \to M ([a,b] \subset I) heißt minimierend, falls L(\gamma\right|_{[a,b]}) \le L(c) ,wobei c eine bel Kurve mit c(a)=\gamma(a), c(b)=\gamma(b) und L(.) die Länage ist.
