...
\begin{Def}
	...
	\item [] Ein nVR $(X,||\cdot||)$ heisst Banachraum, wenn er \underline{vollst"andig} ist, d.h. jede Cauchy-Folge hat einen Grenzwert. Wenn die Norm klar ist, so schreibt man $X$ statt $(X,||\cdot||)$.
