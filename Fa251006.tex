...
Sei $\varepsilon >0$ und $t,s \in [0,1]$ gegeben, w"ahle $n= N_\varepsilon$. Dann $\exists \delta = \delta (n) = \delta (\varepsilon)$, so dass: $|f_n(t)-f_n(s)|\leq \varepsilon$ wenn $|t-s|\leq \delta \; (f_n$ glm. stä"atig) 
\end{Bsp}
\end{document}
