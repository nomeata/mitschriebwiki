...
\chapter{Differentialgleichungen: Grunbegriffe}
...
&= L \lvert \int_{x_0}^x \underbrace{\|y(t)-z(t)\| \varphi_\alpha}_{\leq \|y-z\|_\alpha} \cdot \frac1{\varphi_\alpha(x)}\text{d}t \rvert\\
...
y heißt \textbf{nicht fortsetzbar} $:\iff$ aus $\hat y : \hat J \to \MdR^n\quad(\hat J$ ein Intervall in $\MdR$) ist Lösung von (ii) folgt stets: $\hat J \subseteq J$ und $\hat y = y$ auf $J$.
\end{definition}
