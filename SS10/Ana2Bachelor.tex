...
\[y(x) := e^{\lambda_j x} (v+\frac{x}{1!} (A-\lambda_j I)v + \frac{x^2}{2!} (A-\lambda_j I)^2 v + \cdots + \frac{x^{k_{j-1}}}{ (k_{j-1})! } (A - \lambda_j I)^{k_{j-1}} v )\]
...
k_1 &= 1 &k_2&=1\\
\end{align*}
Also ist $M := \{\lambda_1\}$ Aus Kern$(A-\lambda_1 I) = \left[ \begin{pmatrix} 2i \\ 1 \end{pmatrix} \right]$
folgt:
\begin{align*}
