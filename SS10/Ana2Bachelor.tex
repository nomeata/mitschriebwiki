...
\begin{enumerate}
\item Es sei stets $p(\lambda) := det(A - \lambda E)$ das charakteristische Polynom von $A$ ($E$ = Einheitsmatrix). Sei $\lambda_0 \in \mdc$ ein Eigenwert (EW) von $A$, dann ...
\item Für $\lambda_0$ \in \mdc:$ Kern$(A - \lambda_0 E) \subset$ Kern$((A - \lambda_0 E)^2) \subset$ Kern$((A-\lambda_0 E)^3) subset \ldots$
