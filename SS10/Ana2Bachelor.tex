...
\alpha_k \in \MdR$ und $0 = \alpha_1 y^{(1)}(x_1) + \cdots + \alpha_k y^ 
{(k)}(x_1)$; $\tilde y := \alpha_1 y^{(1)} + \cdots + \alpha_k y^{(k)}$.  
...
eindeutig l"osbar $\implies 0 = \tilde y = \alpha_1 y^{(1)} + \cdots +  
\alpha_k y^{(k)}$. Aus der Voraussetzung folgt dann: $\alpha_1 =  
\alpha_2 = \cdots = \alpha_k = 0 \implies y^{(1)}(x_1), ..., y^{(k)} 
(x_1)$ sind linear unabh"angig im $\MdR^n$.
  \item[(ii)] $\implies$ (iii). Klar \checkmark
  \item[(iii)] $\implies$ (i). Seien $\alpha_1, ..., \alpha_k \in \MdR$  
und $0 = \alpha_1 y^{(1)} + \cdots + \alpha_k y^{(k)} \implies 0 =  
\alpha_1 y^{(1)}(\xi ) + \cdots + \alpha_k y^{(k)}(\xi )$. Aus der  
Voraussetzung folgt dann: $\alpha_1 = \alpha_2 = \cdots = \alpha_k = 0  
...
\end{enumerate}
Ist $y^{(1)}, ..., y^{(n)}$ ein FS von (H), so lautet die allgemeine L"osung von (H): $y(x) = c_1 y^{(1)}(x) + \cdots + c_n y^{(n)} (x) \quad (c_1, ..., c_n \in \MdR)$
\end{definition}
