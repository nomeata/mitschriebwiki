...
Allgemeiner lässt sich zeigen: $\mdq^d:=\{(x_1,\ldots,x_d):x_j\in\mdq (j=1,\ldots,d)\}\in\fb_d$.
\end{enumerate}
\end{beispiel}
...
\]
\item \(\cf_d:=\left\{\bigcup_{j=1}^{n}I_{j}\mid n\in\MdN,\,I_{1},\ldots,I_{n}\in \ci_{d}\right\}\) (\textbf{Menge der Figuren})
\end{enumerate}
\end{definition}
...
\item[I.S.] \begin{align*}
    ...
    &\overset{\text{I.V.}}{\leq}\left(1-\frac{1}{2^{n}}\right) \ep +\frac{\ep}{2^{n+1}}\\
