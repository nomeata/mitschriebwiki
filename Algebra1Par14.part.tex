...
\begin{DefBem}
    ...
    \begin{enum}
        ...
        \item $G$ heißt \emp{zyklisch}, wenn es ein $g \in G$ mit $G=\langle g
        \rangle$ gibt.

        \item Für $g \in G$ ist $\langle g \rangle = \{g^n: n \in \mathbb{Z} \}$
        \newline
        \sbew{0.9}{
        ...
        \sbew{0.9}{
            ...
            für ein $n \in \mathbb{N} \Ra$ Behauptung.
        }
        ...
        \sbew{0.9}{
            ...
            H\}$.\newline Dann ist $\langle g^n \rangle \subseteq H$. Wäre $h
            ...
            (g^n)^b \in H $!\newline
            Widerspruch zur Minimalität von $n$ mit $g^n \in H$
        }
        
        \item Für $g \in G$ heißt ord$(g) \defeqr |\langle g \rangle|$ die 
...
\begin{DefBem}
    ...
    \begin{enum}
        ...
        \leq n : \mbox{ggT}(k,n) = 1\}|$ heißt \emp{Eulersche 
        $\varphi$ -Funktion}.

        \item Ist $G$ zyklische Gruppe der Ordnung $n$, so gibt es für jeden 
