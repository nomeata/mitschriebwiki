...
\item
	Ich muss Farben finden, die sich auch bei einem SW-Ausdruck unterscheiden lassen und diese als Standard definieren. Anschlie\ss end muss ich alle Eintr"age mit den Standardfarben damit ersetzen.
...
Sei $\underset{\subseteq \IP_k^n}{X:= t(V)}$, $\underset{\subseteq \IP_k^m}{Y:= t(V')}$ (abgeschlossene Unterschemata)
	\begin{center}\begin{tikzpicture}
		...
		\draw[->,cyan] (0) -- (2);
		\draw[->,cyan] (1) -- (3);
		\draw[->,cyan] (2) -- node[below]{a)} (4);
		\draw[->,cyan] (3) -- node[below]{a)} (4);
		\draw[->,green] (0) -- node[right]{$g \circ f$} (4);
		\draw[->,green] (1) -- node[left]{$g$} (4);
	\end{tikzpicture}\end{center}
...
Sei $v: K^\X \to G$ die zu $R$ geh"orige Bewertung. W"ahle $j \in \{1,\ldots ,n\}$, sodass $v(f_{j0}) = \min\limits_{k=1}^n v(f_{k0})$ $\Rightarrow v(f_{ij}) = v(f_{i0}) - v(f_{j0}) \ge 0$ f\"ur $i= 0,\ldots ,n \Rightarrow f_{ij} \in R$ f\"ur $i= 0,\ldots ,n \Rightarrow \frac{X_i}{X_j} \mapsto f_{ij}$ definiert Ringhomomorphismus $\Z[\frac{X_0}{X_j},\ldots ,\frac{X_n}{X_j}] \to R$, also Morphismus $\textcolor{green}{h}: T \to U_j \hookrightarrow \IP_\Z^n$
