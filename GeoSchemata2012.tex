...
\item
	...
	\begin{minipage}[c]{0.4\textwidth}\begin{tikzpicture}
		...
		\draw[right hook->] (3) -- (1);
		\draw[right hook->] (2) -- node[right] {$j$} (0);
		\draw[left hook->] (1) -- node[above] {$i$} (0);
		\draw[left hook->] (3) -- (2);
		
		\draw[->, dashed] (0) -- (4);
		\draw[->] (1) to[out=135, in=45] node[above] {$\psi$} (4);
		\draw[->] (2) to[out=180, in=225] node[left] {$\varphi$} (4);
	\end{tikzpicture}\end{minipage}
...
\item
	...
	\begin{center}\begin{tikzpicture}
		...
		\draw[->] (3) -- node[below]{$\varphi$} (1);
		\draw[->] (3) -- node[below]{$p$} (2);
		\draw[->] (1) -- node[above]{$\pi$} (0);
		\draw[->] (2) -- (0);
		
		\draw[->, dashed] (0) -- node[right]{$\exists! f$} (4);
		\draw[->] (1) to[out=90, in=180] node[above]{$\alpha$} (4);
		\draw[->] (2) to[out=90, in=0] node[above]{$\beta$} (4);
	\end{tikzpicture}\end{center}
...
\item
	...
	\begin{center}\begin{tikzpicture}
		...
		\draw[->, dashed] (0) -- (4);
		\draw[->] (1) to[out=90, in=225] node[above]{$\alpha$} (4);
		\draw[->] (2) to[out=90, in=315] node[above]{$\beta$} (4);
