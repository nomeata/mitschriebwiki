...
\begin{Satz}
Sei $X$ projektives Schema "uber einem noetherschen Ring $R$. Dann ist $H^{i}(X, \calF)$ endlich erzeugter $R$-Modul f"ur jede koh"arente Garbe $\calF$ auf $X$.
\end{Satz}
...
$\Rightarrow H^{i}(\IP^n, \bigoplus \calO(d_j))$ endlich erzeugte $R$-Moduln $\xRightarrow{\text{lange ex. Sequenz}}$ Behauptung
\end{bew}
