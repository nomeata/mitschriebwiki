...
\item
	...
	\end{enumerate}
	\begin{center}\textcolor{red}{[BILD]}\begin{tikzpicture}
		...
		\draw (2,2) .. controls (1.75,-0.75) and (1.25,-0.75) .. (1.5,3);
	\end{tikzpicture}\end{center}
\item
	...
	\begin{center}\textcolor{red}{[BILD]}\begin{tikzpicture}
		...
		% cyan ueber dem Achsenkreuz
		\draw[cyan,very thick] (0,-5) -- (0,5);
		\draw[cyan,very thick] (-5,0) -- (5,0);
