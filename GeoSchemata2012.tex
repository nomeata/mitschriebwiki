...
\item
	...
	\textcolor{red}{[BILD]} Es gilt $\id_S \circ \psi = f \circ \varphi$ im unteren Dreieck, also auch im Oberen
\item
	\emph{Zeige:} $X \X_S Y$ erf\"ullt die UAE von $(X \X_S T) \X_T Y$\\
	\emph{Erhalte:} $h:X \X_S Y \to X \X_S T$ auf \textcolor{red}{[BILD]} $\begin{array}{rccc} g: &Y &\to& T \\ f: &X &\to &S \\ h: &T &\to &S\end{array}$\\
	\emph{Betrachte:} \textcolor{red}{[BILD]}\\
