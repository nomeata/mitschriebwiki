...
\textcolor{red}{[Dieses Bild wird bei mir lokal richtig gezeichnet. Bug im Wiki?]}\\
\begin{tikzpicture}
	...
	\draw[orange, line width=5] (1.94,-0.5) arc (345.5:374.5:2);
...
\begin{enumerate}[a)]
\item
	F\"ur $0 \ne f \in R$ sei $\calO_x(D(f)) = R_f$
\item
	Es gibt genau eine Garbe $\calO_x$ auf $X$ mit $\calO_x(D(f)) = R_f$ (\"Ubung)
\end{enumerate}\end{DefBem}
