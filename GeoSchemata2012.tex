...
\newglossaryentry{Morphismus}{name=Morphismus,plural=Morphismen,description={Allgemein eine Abbildung zwischen zwei Objekten \ensuremath{X} und \ensuremath{Y} einer Kategorie \ensuremath{\calC}. Die Menge der Morphismen einer Kategorie wird mit \ensuremath{\Mor_\calC(X, Y)} bezeichnet}}
...
\newglossaryentry{Keim}{name=Keim,plural=Keime,description={\ldots}}

\newglossaryentry{Holomorphe Funktion}{name=Holomorphe Funktion,plural=Holomorphe Funktionen,description={\ldots},text=holomorphen Funktionen}

\newglossaryentry{Isomorphismus}{name=Isomorphismus,plural=Isomorphismen,description={\ldots},parent=Morphismus}

\newglossaryentry{Homomorphismus}{name=Homomorphismus,plural=Homomorphismen,description={\ldots},parent=Morphismus}

\newglossaryentry{Amalgam}{name=Amalgam,plural=Amalgame,description={\ldots }}

\newglossaryentry{Ideal}{name=Ideal,plural=Ideale,description={\ldots }}

\newglossaryentry{Primideal}{name=Primideal,plural=Primideale,description={\ldots },parent=Ideal}
