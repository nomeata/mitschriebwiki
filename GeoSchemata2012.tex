...
\item
	...
	\begin{center}\begin{tikzpicture}
		...
		\draw[->,thick] (0,0) -- (4,-4);
		% safe1 ueber dem Achsenkreuz
		\draw[safe1,thick] (0,-4.9) -- (0,4.9);
		...
		\node at (1.62,-0.5) {\textcolor{safe1}{$t$}};
		\draw[thick] (-1.62, 0.2) -- (-1.62, -0.2);
		\node at (-1.62,0.5) {\textcolor{safe1}{$-1$}};
		
		\node at (2.5,-0.5) {\textcolor{safe1}{$X_{(t-1)}$}};
		\node at (-2,-4) {\textcolor{safe1}{$X_{(t+1)}$}};
		...
		\draw[safe1] (2,2) .. controls (1.75,-0.75) and (1.25,-0.75) .. (1.5,3);
...
\item
	...
	\begin{center}\begin{tikzpicture}
		...
		% safe1 ueber dem Achsenkreuz
		\draw[safe1,very thick] (0,-4.9) -- (0,4.9);
		\draw[safe1,very thick] (-4.9,0) -- (4.9,0);
