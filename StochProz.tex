...
\begin{definition}
Ein Prozess, bei dem endlich-dimensionalen Verteilungen Normalverteilungen sind, heißt \emph{Gauss-Prozess}\index{Gauss-Prozess}.
...
Außerdem ist für $0\le t_1\le\cdots\le t_n$ der Vektor $(B_{t_1},B_{t_2}-B_{t_1},\ldots,B_{t_n}-B_{t_{n-1}})\sim N(0,\Sigma)$ multivariant normalverteilt. Aus diesem Vektor erhalten wir duch Multiplikation mit einer geeignten Matrix den Vektor $(B_{t_1},\ldots,B_{t_n})$, der demnach auch normalverteilt ist.
