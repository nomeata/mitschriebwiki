...
Es sei $L^2=L^2([0,1],\borel_{[0,1]}, \lambda_{[0,1]}) \da \{f :[0,1]\to \MdR\text{ messbar} \mid \int_0^1 f^2(x)dx <\infty\}$ beziehungsweise der Äquivalenzklassen. Versehen mit
\[
...
\end{align*}
Offenbar ist $f_{mk}(s)=\langle 1_{[0,s]},g_{mk}\rangle$
