...
\begin{Def}
  ...
  \begin{enumerate}
    ...
    \item Ein \emp{Tensorprodukt}\index{Tensorprodukt} von $M$ und $N$ (über $R$)
          ...
          genau eine lineare Abbildung $\tau: T \to P$ mit $\Phi = \varphi \circ
          \tau$
          \[
            \begin{xy}
              \xymatrix{
...
\begin{nnBsp}
  \begin{enumerate}
    \item[1.)] $M, N$ freie $R$-Moduln mit Basis $\{e_i, i \in I\} bzw. \{f_j, j
               ...
               \mbox{Bild}(\tau) \rangle = M \otimes N$.
...
\begin{Bem}
  ...
  \begin{enumerate}
  	...
  	\item $\underbrace{(M_1 \otimes_R M_2) \otimes_R M_3}_{=: \mbox{rechts}} \cong 
	\underbrace{M_1 \otimes_R ( M_2 \otimes_R M_3)}_{=: \mbox{links}}$
  \end{enumerate}
\end{Bem}
\begin{Bew}
  \begin{enumerate}
    ...
    \item[c)] Finde lineare Abbildung: rechts $\rightarrow$ links
	  \begin{enumerate}
	    \item[ 1. ] Für festes $x \in M_3$ ist $\Phi_z: M_1 \times M_2 \rightarrow \mbox{links}$, 
		  ...
		  $\Phi_z$ bilinear: klar\\
		  $\Phi_z$ induziert eine lineare Abbildung: $\varphi_z: M_1 \otimes_R M_2 \rightarrow \mbox{links}$
		  Weiter ist $\Psi: ( M_1 \otimes_R M_2 ) \times M_3 \rightarrow \mbox{links}$,
...
\begin{Prop}
  ...
  $M/_{I \cdot M} \cong M \otimes_R R/_I$
\end{Prop}
...
\begin{Bew}
  ...
  $\tilde{\varphi}(ax) = ax \otimes \overline 1 = x \otimes \underbrace{ a \cdot 1 }_{\overline a} = 0$\\
  $\tilde{\varphi}$ induziert also lineare Abbildung\\
  $\varphi: M/_{I \cdot M} \rightarrow M \otimes_R R/I\\
  ...
  $\overline{ \Psi}$ ist bilinear, induziert also $\Psi: M \otimes R/I \rightarrow M/_{I \cdot M}$ (linear). Es ist 
  $(\psi \circ \varphi)(\overline x )= \psi(x \otimes \overline 1 ) = \overline{1x} = \overline x = 
