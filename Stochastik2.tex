...
\begin{Def} Die \textbf{Produkt-$\sigma$-Algebra}\index{Produkt-$\sigma$-Algebra}\index{$\sigma$-Algebra!Produkt-} $\AA:=\bigotimes_{i\in I}\AA_i$ ist die kleinste $\sigma$-Algebra mit der Eigenschaft, dass für alle $i\in I$ die Abbildung $\Pi_i$ $(\AA,\AA_i)$-messbar ist. Genauer: \\
\begin{displaymath}
\AA := \sigma \left( \bigcup_{i\in I} \left\{ \Pi^{-1}_i(A_i) | A_i \in \AA_i\right\}\right)
\end{displaymath}
\end{Def}

\begin{Bem} Sei $J\subset I$, $\Pi_i:\Omega\to\times_{i\in I}\Omega_i$, $\Pi_i(\omega)(j)=\omega_j$ ($j\in J)$ die Projektion auf die $J$-Koordinaten, so bildet \\
\begin{displaymath}
