...
$\Rightarrow Y^T Y \stackrel{d}{=} \sum_{i=1}^{d-1} W_i^2,\ W_i \sim N(0,1)$ unabh. $\Rightarrow h(Z) = \tilde{Z}^T \tilde{Z} = Y^T Y \sim \xi_{d-1}^2,\ \text{Chi}^2$-Verteilung mit $d-1$ %Freiheitsgraden.\\
...
$P_p(T_n > c_{\alpha}) \stackrel{!}{=} 0,05 \ \Leftrightarrow 1 - F_{\xi_5^2}(c_{\alpha}) \stackrel{!}{=} \Rightarrow c_{\alpha} = 11,1$. d.h. Nullhypothese ``W"urfel fair'' kann nicht abgelehnt werden.
\end{Bsp}
