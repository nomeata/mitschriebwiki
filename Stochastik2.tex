...
\item[2.] Der ZGWS hat eine lange "Verbesserungsgeschichte" hinter sich. Gelegentlich ist die Lyapunov-Bedingung einfacher zu verwenden: $\lim_{n \rightarrow \infty} \frac1{s_n^{2+\delta}} \sum_{k=1}^{r_n} E(|X_{nk} - \mu_{nk}|)^{2 + \delta} = 0$ f"ur ein $\delta > 0$.
