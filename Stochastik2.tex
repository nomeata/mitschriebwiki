...
\begin{Bew}
Folgt aus der Definition und S.3.4.
\end{Bew}
...
\begin{Bew}
\begin{enumerate}
\item[a)] Sei $B_n := \cup_{k=n}^{\infty} A_k,\ n \in \N \Rightarrow P(B_n) \leq \sum_{k=n}^{\infty} P(A_k) \stackrel{n \rightarrow \infty}{\longrightarrow} 0$. Da $B_n \downarrow \cap_{n=1}^{\infty} B_n$ folgt:
\[
