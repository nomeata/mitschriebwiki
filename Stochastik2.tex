...
Sei $p_n = P(\sum_{k=1}^n D_k > 0)$ die Wahrscheinlichkit, dass Spieler A nach $n$ Runden mehr Punkte hat. Es gilt nach S.\ref{Sa4.2}:
...
\chapter{Den Zentrale Grenzwertsatz von Lindeberg-L\'evy}
...
ist $|\psi| \leq b-a$, also ist $\psi$ $P^X\otimes\lambda_{[-T,T]}$-integrierbar. Mit Satz 3.3 (Fubini I) folgt:
...
2\pi, & a<x<b
\end{cases}$$
Weiter: $\sup_{x>0}\{|Si(x)|\}<\infty$. \\
Der Beweis ist noch nicht zu Ende. Sehen wir weiter am Montag...
\end{Bew}
