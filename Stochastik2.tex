...
F"ur jedes $n \in \N$ seien $X_{nk}, k=1,\dots,r_n$ unabh ZV (nicht notwendig identisch verteilt) auf einem W'Raum (\Sigma_n,\SchwungA_n,P_n)$ mit $\Var(X_{nk} = \sigma_{nk}^2 < \infty$ und $EX_{nk} = \mu_{nk} < \infty$. Es sei $s_n^2 := \sum_{k=1}^{r_n} \sigma_{nk}^2 > 0$. Ist dann die Lindeberg-Bedigung
\[
