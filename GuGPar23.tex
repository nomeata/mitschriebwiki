...
\begin{nnBsp}
\begin{enumerate}
  \item[(1)] $\Z$ operiert auf $\Gamma(\Z, \{1\})$ durch Translation $(2\Z)$.
  ...
  $\Z$ operiert auf $\Gamma(\Z, \{2\})$ durch Vertauschen der beiden Komponenten
  $(1 + 2\Z)$.
  ...
  Hier ist $\varphi: G \to \Aut(\Gamma(G,S))$ injektiv, aber nicht surjektiv.
  \item[(3)] $S_3$
  ...
  $\varphi_{\tau}(\sigma) = \tau \sigma = \sigma \tau^2 \Rightarrow
  \varphi_{\tau}$ ist Drehung um $120^{\circ}$ nach rechts.\\
  $\sigma$ vertauscht rechts mit links und innen mit außen.

  \item[(4)] $G = A_4$, $S = \{ \underbrace{(123)}_{\color{blue}\tau}, \underbrace{(12)(34)}_{\color{red}\sigma} \}$

\centering\fbox{\xygraph{
!{<0cm,0cm>;<1cm,0cm>:<0cm,1cm>::}
!{(0,2)}  *!L(2){id}        *+{\bullet}="id"
!{(-1,3)} *!D(2){(132)}	    *+{\bullet}="132"
!{(+1,3)} *!D(2){(123)}	    *+{\bullet}*+{\bullet}="123"
!{(2,0)}  *!DR(1.3){(13)(24)}  *+{\bullet}="13.24"
!{(3,+1)} *!L(2){(243)}	    *+{\bullet}="243"
!{(3,-)}  *!L(2){(124)}     *+{\bullet}="124"
!{(-2,0)} *!UL(1.3){(14)(23)}  *+{\bullet}="14.23"
!{(-3,+1)}*!R(2){(143)}     *+{\bullet}="143"
!{(-3,-)} *!R(2){(142)}     *+{\bullet}="142"
!{(0,-2)} *!DL(1.3){(12)(34)}  *+{\bullet}="12.34"
!{(-1,-3)}*!U(2){(134)}     *+{\bullet}="134"
!{(+1,-3)}*!U(2){(234)}     *+{\bullet}="234"
"id"-@{>}@[blue]_{\color{blue}\tau}"123"
"123"-@{>}@[blue]"132"
"132"-@{>}@[blue]"id"
"13.24"-@{>}@[blue]"243"
"243"-@{>}@[blue]"124"
...
Sei $G$ eine abz\"ahlbare Gruppe. Dann gibt es einen zusammenh\"angenden Graphen $\Gamma$ mit $\Aut(\Gamma) \cong G$.

\begin{nnBsp}
$G = V_4 = D_2 = \{1, \sigma, \tau, \sigma\tau\}$. $S = \{\sigma, \tau\}$. $\Gamma = \Gamma(G,S)$.

\centering\fbox{\xygraph{
!{<0cm,0cm>;<1cm,0cm>:<0cm,1cm>::}
!{(0,2)}*+{\bullet}*!R(4){1}="1"
!{(2,2)}*+{\bullet}*!L(4){\sigma}="s"
!{(0,0)}*+{\bullet}*!R(4){\tau}="t"
!{(2,0)}*+{\bullet}*!L(2){\sigma\tau}="st"
"1"- @[red]@`{(1,2.4)} "s"
"1"- @[red]@`{(1,1.6)} "s" |\bot
"s"- @[blue]@/^0.2cm/ "st"
"s"- @[blue]@/_0.2cm/ "st"
...
% TODO: Wie kriegen wir die Antennen hin?
\end{nnBsp}

\begin{Bew}
Sei $S = \{s_1, s_2, \ldots\}$ ein Erzeugendensystem. $\tilde{\Gamma} = \Gamma(G,S)$.

F\"ur $i \geq 1$ sei $T_i$ der Baum 
\fbox{\xygraph{
!{<0cm,0cm>;<1cm,0cm>:<0cm,1cm>::}
!{(0,0)}*+{\bullet}*!D(2){a_i}="ai"
!{(2,0)}*+{\bullet}*!D(2){p_i}="pi"
!{(4,0)}*+{\bullet}*!D(2){q_i}="qi"
!{(6,0)}*+{\bullet}*!D(2){b_i}="bi"
!{(2,-1)}*+{\bullet}="pi1"
!{(4,-1)}*+{\bullet}="qi1"
!{(2,-2)}*+{\bullet}="pi2"
!{(4,-2)}*+{\bullet}="qi2"
!{(2,-3)}*+{\bullet}*!R(2){p_i'}="pie"
!{(4,-3)}*+{\bullet}*!R(2){q_i'}="qie"
"ai"-"pi"
"pi"-"qi"
"qi"-"bi"
"pi"-"pi1"
...
\\mit $d(p_i,p_i') = 2i$, $d(q_i,q_i') = 2i + 1$.

Dann ist $T_i \neq T_j$ f\"ur $i \neq j$ und $\Aut(T_i) = \{id\}$.\\
Sei $\Gamma$ der Graph, der aus $\tilde\Gamma$ entsteht, indem jeder Teilbaum
\xygraph{
!{<0cm,0cm>;<1cm,0cm>:<0cm,1cm>::}
!{(0,0)}*+{\bullet}*!U(2){g}="g"
!{(1,0)}*+{\bullet}*!U(2){gs_i}="gs"
"g"-@{>}"gs"
}
($k=(g,s_i,1)$) ersetzt wird durch $T_i$.

$\Gamma \rightarrow \tilde\Gamma$, $T_i \rightarrow $
\xygraph{
!{<0cm,0cm>;<1cm,0cm>:<0cm,1cm>::}
!{(0,0)}*+{\bullet}*!U(2){g}="g"
!{(1,0)}*+{\bullet}*!U(2){gs_i}="gs"
...
ist surjektiver Morphismus.

Dann gilt:
\begin{itemize}
\item $G$ operiert auf $\Gamma$:
\xygraph{
!{<0cm,0cm>;<1cm,0cm>:<0cm,1cm>::}
!{(0,0)}*+{\bullet}*!U(2){g}="g"
!{(2,0)}*+{\bullet}*!U(2){gs_i}="gs"
"g"-@{>}"gs"
}
\hspace{1cm}$\underset{\rho(g')}{\longrightarrow}$\hspace{1cm}
\xygraph{
!{<0cm,0cm>;<1cm,0cm>:<0cm,1cm>::}
!{(0,0)}*+{\bullet}*!U(2){g'g}="g"
!{(2,0)}*+{\bullet}*!U(2){g'gs_i}="gs"
"g"-@{>}^{(g'g,s_i,1)}"gs"
}
