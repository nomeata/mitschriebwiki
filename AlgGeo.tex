...
"'$\Leftarrow$"' Sei $x\neq y\in X,~~W$ eine offene Umgebung von $(x,y)$ in $X\times X$ mit $W\cap \Delta=\emptyset$ \OE~~$W=U\times V$, da die $U\times V$ eine Basis der Toplogie auf $X\times X$ bilden $\Rightarrow U\cap V=\emptyset$ 
\end{Bew}
