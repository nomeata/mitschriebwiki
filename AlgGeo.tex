...
\end{Beo}
\begin{Def}
  Eine Teilmenge $V\subseteq\mathbb P^n(k)$ heißt projektive Varietät, wenn es eine Menge $\mathcal F\subset k[X_0,\dots,X_n]$
...
\begin{DefBem}
  \begin{enumerate}
  \item $S=k[X_0,\dots,X_n]$ ist graduierter Ring (genau graduierte $k$-Algebra) das heißt:
    \[
...
\end{DefBem}
\begin{Bew}
  c.) Seien $I_1,I_2$ homogene Ideale mit homogenem Erzeuger $(f_i)_{i\in \mathcal I}$ beziehungweise
    ...
    $\Rightarrow x_n^m\in I \Rightarrow x_n\in\sqrt{I}$ mit Indunktion folgt die Behauptung.
 \end{Bew}
