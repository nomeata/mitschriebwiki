...
\section*{Wer}
Getippt wurde das Skriptum soweit von Diego de Filippi, die Wiki-Technik ist von Joachim Breitner.
...
\begin{align*}
&\implies \alpha(m_y)\subseteq m_x \\
&\implies m_y\subseteq\alpha^{-1}(m_x) \\
&\implies m_y=\alpha^{-1}(m_x)
\end{align*}
\end{Beh}
\begin{Prop}[6.6]
...
\end{Prop}
\begin{Bew}
  ''$\implies$'' f ist stetig nach \ref{bem:5.3}
\end{Bew}
