...
Das Urbild von $\{1,1\}$ z.B. ist $V(X_0-X_1)\setminus\{(0:0:1)\}$, also nicht abgeschlossen.
...
Sei $g_i$ die Projektion auf diese Komponente. Dann ist $g\circ f=f_i$ kein Morphismus, also $g\circ f\notin \mathcal O_V(f^{-1}(U))$ 
\end{Bew}
\begin{Folg}
  \label{folg:11.3}
