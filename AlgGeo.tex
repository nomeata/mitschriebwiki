...
\begin{Prop}
  ...
  offene Umgebungen $U_1\subseteq V$ vin $x$ und $U_2\subseteq W$ vin $y$ mit $U_1\cong U_2$.
\end{Prop}
\begin{Bew}
...
\begin{Def}
  \label{def:15.1}
  Sei $X$ ein topologischer Raum ($\neq\emptyset$). Dann heißt $\dim(X)\defeqr\sup\{n\in\mathbb{N}:\text{ es gibt irreduzible Teilmengen }
  \emptyset\neq V_0\subsetneq \dots\subsetneq V_n\}$ \begriff{(Krull-)Dimension} von $X$. 
\end{Def}
\begin{ErinnDef}
  \label{def:15.2}
...
\begin{Bew}
  ...
  $I(Z)$ ein Primideal ist. Nach \ref{HNS} ist das eine Bijektion.
\end{Bew}
\begin{Prop}
  \label{prop:15.4}
  \begin{enumerate}
