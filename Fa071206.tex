...
Schreibe $z \in \R^{n \times n}$ als $z = (x,y)$ mit $x \in \R^n, y \in \R^n$. Seien $A \in \LL_m, B \in \ssL_n \Rightarrow A \times B \in L_{m+n}$.\\
...
Sei $k \in L^2(A \times A), A \in \LL_d, f \in L^2(A)$. Nach Bem. 1.34 ist
\[
...
\]
Insbesondere:\\
$T$ unitär $\Leftrightarrow T$ bijektiv und $T$ Isometrie $\Leftrightarrow T$ bijektiv und erh"alt Skalarprodukt
\end{Sa}
