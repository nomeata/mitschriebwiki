...
\draw[pattern color=red,pattern=north east lines] (-0.3,1) -- (-0.3,-1) -- (-0.5,-1) -- (-0.5,1) -- cycle;
\draw[pattern color=blue,pattern=north west lines] (-1,0.3) -- (1,0.3) -- (1,0.5) -- (-1,0.5) -- cycle;
...
\begin{scope}[xshift=2.5cm]
\filldraw [pattern color=red,pattern=north east lines] (0,0) circle (0.5cm);
\filldraw [white] (0,0) circle (0.3cm);
\draw (0,0) circle (0.3cm);

\begin{scope}
\clip (0,0) rectangle (1,1);
\filldraw[pattern color=blue,pattern=north west lines] (0,0) -- (30:2) -- (60:2) -- cycle;
\end{scope}
