...
\filldraw[red] (30:-2) -- (-1.2,1.2) -- (1.2,1.2) -- (30:2) -- cycle;
\filldraw[blue] (30:-2) -- (-1.2,-1.2) -- (1.2,-1.2) -- (30:2) -- cycle;
...
\item {\bf Vertikale Gerade} $x=\Re{z}=a$ (\reell{a} fest). Die Exponentialfunktion bildet diese Gerade ab auf den Kreis
  $\partial B(0,\e^a)$ (lasse in (\ref{eqn1.7}) \reell{y} laufen). Dies ist surjektiv, aber nicht injektiv.
\end{itemize}
...
\filldraw[red] (-0.3,1) -- (-0.3,-1) -- (-0.5,-1) -- (-0.5,1) -- cycle;
\filldraw[blue] (-1,0.3) -- (1,0.3) -- (1,0.5) -- (-1,0.5) -- cycle;
\filldraw[green] (-0.3,0.3) -- (-0.3,0.5) -- (-0.5,0.5) -- (-0.5,0.3) -- cycle;
...
\begin{scope}[xshift=2.5cm]
\filldraw [red] (0,0) circle (0.5cm);
\filldraw [white] (0,0) circle (0.3cm);

\begin{scope}
\clip (0,0) rectangle (1,1);
\filldraw[blue] (0,0) -- (30:2) -- (60:2) -- cycle;
\end{scope}

\filldraw[green] (0,0) -- (30:0.5) arc (30:60:0.5) -- cycle;
\filldraw[blue] (0,0) -- (30:0.3) arc (30:60:0.3) -- cycle;
...
\parbox[c]{.3\textwidth}{\tikz[scale=3]{\draw[->] (0,0) node [left] {$z_1$} -- (0.5,-0.1) node [below] {$z_2$}; \draw[->] (0.5,-0.1) -- (0.1,0.3) node [right] {$z_3$}; \draw[->] (0.1,0.3) -- (0,0);}}}
\item \mbox{\parbox[c]{.4\textwidth}{Kreis mit Griff $\partial B(c,r)\cup[1,2]$:}\parbox[c]{.3\textwidth}{\tikz[scale=5]{\draw[->] (0,-0.2) -- (0,0.2);\draw[->] (-0.2,0) -- (0.25,0); \draw[->,thick] (-50:0.1) arc (-50:60:0.1); \draw[->,thick] (60:0.1) arc (60:160:0.1); \draw[->,thick] (160:0.1) arc (160:310:0.1); \draw[->,thick] (0.1,0) -- (0.2,0); \draw (0.1,1pt) -- (0.1,-1pt) (0.2,1pt) -- (0.2,-1pt) (0.1,-0.5pt) node[below] {$_1$} (0.2,-0.5pt) node[below] {$_2$} (-0.1,0.1) node [left] {$\Gamma_1$} (0.1,0.1) node [right] {$\Gamma_2$};}}}
\end{itemize}
