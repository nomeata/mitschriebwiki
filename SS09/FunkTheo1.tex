...
\item Sei $w_0\in\Delta$.
  \begin{enumerate}
  \item Sei $w_0$ eine Ecke von $\Delta$. Sei $\ep>0$. Zerlege $\Delta$ wie in 1) per Seitenhalbierung. Wähle dabei stets
    Teildreieck mit Ecke $w_0$. Erhalte Dreiecke $\Delta_1^*,\dotsc,\Delta_m^*$ mit disjunktem Inneren, sodass
    $w_0\in\Delta_1^*$, $l(\partial\Delta_1^*)\le\ep$, $w_0\notin\Delta_k^*$ für $k\ge2$. Wie in 1) erhalten wir
    \[\Biggl\lvert\,\Integral{\partial\Delta}{}{f}{z}\Biggr\rvert = \Biggl\lvert\sum_{k=1}^m{\Integral{\partial\Delta_k^*}{}{f}{z}}\Biggr\rvert =
    \Biggl\lvert\,\Integral{\partial\Delta_1^*}{}{f}{z}\Biggr\rvert \le \ep \underbrace{\sup_{z\in\Delta}{\abs{f(z)}}}_{<\infty}. \]
    Da $\ep>0$ beliebig war, folgt $\displaystyle\integral{\partial\Delta}{}{f}{z} = 0$.\qedhere
  \end{enumerate}
\end{enumerate}
\end{proof}
