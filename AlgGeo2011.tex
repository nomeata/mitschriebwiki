...
\begin{Def}
Eine Teilmenge $V\subseteq\IP^n(k)$ hei\ss t \begriffspez{projektive Variet\"at}{Variet\"at!projektive-}, wenn es eine Menge $F\subset k[X_o,\dots ,X_n]$ von homogenen Polynomen gibt mit $V=\{x\in\IP^n(k):f(x)=0\forall f\in F\}$
\end{Def}
