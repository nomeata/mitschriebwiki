...
\def\section@cntformat{Â§\@arabic\c@section\quad}
\makeatother
...
\section*{Wo}
(kommt noch, falls ich das Skript auch im Mitschriebwiki ver\"offentliche)\\
...
$\Rightarrow V_j\subseteq V_j \Rightarrow i=j\Rightarrow W=V_i$\\
\emph{Eindeutigkeit:} Sei $W$ irreduzible Komponente von $V$.\\
...
\item
	Ein Morphismus $f: V\to W$ hei\ss t \begriffspez{Isomorphismus}{Morphismus!Iso-}, wenn es einen Morphismus $g:W\to V$gibt mit \[ g\circ f = \id_W \textrm{ und } f\circ g = \id_V\]
...
\item
	$\mathcal O(U):=\{f:U\to\A^1(k): f \textrm{ regul\"ar}\}$ hei\ss t $k$-Algebra (oder Ring) der \begriffspez{regul\"aren Funktionen}{regul\"ar!-e Funktionen} auf $U$.
...
\item
	ist die \begriff{Garbeneigenschaft}\index{Garbe!-eigenschaft}
...
\item
	Eine Teilmenge $U\subseteq \A^n(k)$ hei\ss t \begriffspez{quasi-affine Variet\"at}{Variet\"at!-quasi affine}, wenn $U$ Zariski-offen in einer affinen Variet\"at $V$ ist.
...
Dann hei\ss t $K[V]:=\FakRaum{k[X_0,\ldots ,X_n]}{I(V)}$ \begriffspez{homogener Koordinatenring}{Koordinatenrig!homogener-} zu $V$.
\end{Def}
...
\item
	Eine Teilmenge $W\subseteq \IP^n(k)$ hei\ss t \begriff{quasi-projektive Variet\"at}\index{Variet\"at!quasiprojektive-}, wenn $W$ offene Teilmenge einer projektiven Variet\"at ist.
\item
