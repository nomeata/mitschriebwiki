...
\item[a)]
	\OE $V$ irreduzibel
	\begin{description}[\setlabelstyle{\itshape}]\item[denn:] Sei $V=\bigcup\limits_{j=1}^r V_j, V_j$ irreduzibel. Ist $h|_{V_j}=c_j$ konstant f\"ur jedes $j$, so ist $c_i=c_j$ falls $V_i\cap V_j\not= \emptyset$. Da $V$ zusammenh\"angend ist, ist $h$ konstant.
	\end{description}
