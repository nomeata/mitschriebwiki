...
\item \ref{prop8.6} fehlt Bew.: könnte z.B. so gehn: \" $ \Leftarrow $ \" Seien $g,h \in k[W]: g \circ f=h \circ f \Rightarrow g(f(x))=h(f(x)) \forall x \in V f(V) dicht \Rightarrow g=h    \" \Rightarrow \" Ang. f nicht dom. \Rightarrow I(f(V))\neq {0} \Rightarrow \exist g \neq 0 \in I und g \circ f=0 Wid. zu inj.$
