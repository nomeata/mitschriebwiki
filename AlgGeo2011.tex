...
\item
	...
	\begin{center}
		\textcolor{red}{[BILD]} \textcolor{red}{[BILD]} \textcolor{red}{[BILD]} \textcolor{red}{[BILD]}
		...
		\begin{tikzpicture}[scale=0.25]
			...
			\draw (0,0) ..controls(0,1.75) and (-0.25,3).. (1,4) ..controls(2.25,4.75) and (3.75,5.25).. (4.5,4.5) ..controls(5,4.25) and (5,2.25).. (3.75,1) ..controls(3.25,0) and (2.25,0).. (0,0);
			\draw[red] (5,4.25) circle[radius=0.1];
		\end{tikzpicture}
		\begin{tikzpicture}[scale=0.25]
			\draw[ultra thin, densely dashed] (0,-6.5) -- (0,6.5);
			\draw[ultra thin, densely dashed] (-3,0) -- (10,0);
...
\begin{Aufg}[4 Punkte]
F"ur diese Aufgabe habe der K"orper $k$ die Charakteristik $0$. Sei $V$ eine projektive Hyperfl"ache in $\Projective^n(k)$, d.h. $V = V(f)$ für ein homogenes, quadratfreies Polynom $f \in k[X_0, \dots, X_n] \setminus k$.
\begin{enumerate}[a)]
