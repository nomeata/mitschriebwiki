...
\item Teilmengen und abzählbare Vereinigungen von abzählbare $n$-rektifizierbaren Mengen sind abzählbar  $n$-rektifizierbare Mengen.
...
dass gilt 
\begin{enumerate}[\quad(a)]
\item $R= A\cap R_0$ mit einer abzählbar $n$-rektifizierbare Borelmenge $R_0\subset \MdR^p$.
...
\[
\HM^n\MR \left(\frac{M-x}{\lambda}\right) \tonach{v} \HM^n\MR P\qquad \text{für $\lambda \mathop\searrow0$,}
\]
