...
\begin{bem}[Integration rationaler Funktionen]
  ...
  \item \label{par:int.fundamentalsatz-algebra} Fundamentalsatz der Algebra: $\exists!\
    ...
    \item Integration:
      ...
      \item Komplexer Fall für Nennerpotenz $k=1$: Da $p_0$, $q$
        ...
        \end{equation}
      \end{enumerate}
      mit \reell{a,b,\alpha,\beta}, $\beta>\frac{\alpha^2}{4}$. \\
...
\begin{bsp*}
  \begin{enumerate}
  \item Seien \reell{a,b} gegeben, $a\ne b$,
    ...
    \tag{$*$} \end{equation}
    (für zu bestimmende \reell{c_1,c_2})\\
    Berechne $c_1$, $c_2$: (\ref{eqn:int.ratfkt-stern-a}) gilt nach
    stetiger Fortsetzung für alle \reell{x}. Einsetzen:
    \begin{align*}
...
\begin{bem*}
  ...
  $u(t)=u_\infty$ mit $u_0=u_\infty$ (für alle \reell{t}). Im
  folgenden sei $u_0\neq u_\infty$, $u_0>0$.
\end{bem*}
...
\begin{satz}[Trennung der Variablen]
  \label{satz:int.tv}
...
\begin{proof}
  ...
  fortgesetzt werden. %TODO Fehler bei den Intervallen? muss das erste nicht \tau sein??
\end{proof}
...
\begin{bsp}
  ...
  \item \[\text{Sei } a\in C(\set{R}),\
    ...
    Probe zeigt: Dies löst die Gleichung für alle \reell{t} und
    \reell{u_0}.
