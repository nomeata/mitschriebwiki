...
\emph{Bew:} Sei $l(x) := \lim_{n \rightarrow \infty} x_n,\ x \in c.$ "Ub: $l \in c^{\ast}$. 1.68 b) $\Rightarrow R \in B(c), L \in B(c_0)$. Setze $Tx := Rx - l(x) \id = (-l(x), x_1-l(x), \dots )$\ f"ur $x \in c \Longrightarrow  T \in B(c,c_0). \ Sx := Lx - x_1\id = (x_2-x_1, x_3-x_1, \dots )$\ f"ur $x \in c_0.\ S \in B(c_0,c)$. Einsetzen: $ST = I_c,\ TS = I_{c_0}$ \eb
