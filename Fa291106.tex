...
%Def 1.69
\begin{Def}
Seien $X,Y$ nVr. Eine injektive stetige lineare Abb $T: X \rightarrow Y$ hei"st \begriff{Einbettung}. Man schreibt dann $X \besondererPfeilnachrechts Y$. Wenn $T \in B(X,y)$ bijektiv und $T^{-1}: Y \rightarrow X$ stetig, dann hei"st $T$ \begriff{Isomorphismus} und man schreibt $X \=mitSchlangedrüber Y$. Eine lineare Abbildung $T: X \rightarrow Y$ mit $||Tx|| = ||x||$, hei"st \begriff{Isometrie}
\end{Def}
