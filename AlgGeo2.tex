...
\begin{Def}
  ...
  \begin{enumerate}
  \item $\mathcal F$ heißt \begriff{quasi-kohärent}, wenn es eine offene affine Überdeckung $(U_i=\Spec R_i)_{i \in I}$
    von $X$ und $R_i$-Moduln $M_i$ gibt, sodass 
    \begin{align*}
