...
\begin{nnBsp}
  ...
  \item[2.)] $A = R \llbracket X \rrbracket, d = \frac{d}{dX}$ wie in 1.) mit
    ...
    $d\left(Q\right) = d\left(S+X^nP\right) = d\left(S\righ) + d\left(X^n P\right) \equiv d\left(S\right)
...
$\Omega_{B/A}$ und eine Derivation $d_{B/A} : B \to \Omega_{B/A}$ mit folgender UAE: \\
  Zu jedem $B$-Modul $M$ und jeder $A$-linearen Derivation $\delta: B \to M$
  existiert genau eine $B$-lineare Abbildung $\varphi: \Omega_{B/A} \to M$ mit
  $\delta = \varphi \circ d_{B/A}$. \\
...
$\beta : \Omega_{B/R} \to \Omega_{B/A} $ mit $d_{B/A} = \beta \circ d_{B/R}$. \\
Mit diesem $\beta$ ist
