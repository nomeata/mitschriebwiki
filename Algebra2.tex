...
\begin{PropDef} \label{1.21}
  ...
  folgender UAE:\\
  Zu jedem $A$-Modul $M$ und jeder Derivation $\delta: A \to M$
...
heißt \emp{de Rham-Komplex}\index{de Rahm-Komplex} zu $A$, und wird mit $\Omega^\bullet_A$ bezeichnet.
...
\textbf{Existenz der Folge $\left(d_i\right)_{i\geq 0}$:}
