...
\begin{Bew}
  ...
  \item[c)] $\Lambda^r(M)$ wird erzeugt von $e_1 \wedge \dots \wedge e_r$: klar.\\
    ...
    welche $a \cdot e_1 \wedge \dots \wedge e_r = 0$ auf $a=0$ sendet).
    ...
    Dann ist $ 0= (\sum a_{\underline{i}} e_{i_1} \wedge \dots \wedge e_{i_n}) \wedge 
    e_{\sigma_j(n+1)}  \wedge \dots \wedge e_{\sigma_j(r) } 
    = a_{\underline{j}} (e_{j_1} \wedge \dots \wedge e_{j_n}) \wedge e_{\sigma_j(n+1)}  \wedge \dots \wedge e_{\sigma_j(r) } 
    = \pm a_{\underline{j}} e_1 \wedge \dots \wedge e_r$, also
...
Setze $\Omega_A := \Omega_{A/R}$. Dies ist ein $A$-Modul. Für jedes $i\geq 0$ setze $\Omega^i_A := \Lambda^i\Omega_A$ (wobei $\Lambda^i \Omega_A$ die $i$-te äußere Potenz des $A$-Moduls -- nicht des $R$-Moduls -- $\Omega_A$ bedeutet).
