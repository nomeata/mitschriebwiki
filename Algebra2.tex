...
(ii) folgt leicht aus der Identität $d_k(dX_{i_1}\wedge \cdots \wedge dX_{i_k}) = 0$ nach Induktion über $k$. [Wirklich??]
...
\stackrel{(*)}{=}\sum_{i=1}^{n}d(\partial_i f) \wedge dX_i\wedge \omega
