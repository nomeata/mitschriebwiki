...
\label{1.1}
  \begin{enumerate}
    \item Eine abelsche Gruppe $(M,+)$ zusammen mit einer Abbildung
          $\cdot : R \times M \to M$ heiÃt \emp{$R$-Modul}\index{R-Modul} (genauer:
    ...
    \item Eine Abbildung $\varphi: M \to M'$ zwischen $R$-Modulen $M$, $M'$
          heiÃt \emp{$R$-Modul-Homo\-morphismus}\index{R-Modul!-Homomorphismus} (kurz
          \emp{$R$-linear}\index{R-linear}), wenn fÃ¼r alle $x,y \in M, \; a,b \in R$
          gilt:\\
...
\begin{BemDef}
  \begin{enumerate}
    ...
    \item $M^* = \mbox{Hom}_R(M,R)$ heiÃt dualer Modul.\index{R-Modul!dualer}
  \end{enumerate}
\end{BemDef}
...
\begin{Bem}[Ãhnlichkeiten von Moduln mit VektorrÃ¤umen]
...
\begin{Bem}
  \begin{enumerate}
    ...
    \item $B \subset M$ heiÃt \emp{linear unabhÃ¤ngig}\index{linear unabhÃ¤ngig},
    ...
    \item Ein $R$-Modul heiÃt \emp{frei}\index{R-Modul!freier}, wenn er eine
          Basis besitzt.
...
\begin{PropDef}
  ...
  \begin{enumerate}
    ...
    \item Ein Modul $N$ heiÃt \emp{projektiv}\index{R-Modul!projektiver} (bzw.
...
\begin{Bew}
  \begin{enumerate}
	...
	\item Im Allgemeinen sind $\beta_*$ und $\alpha^*$ nicht surjektiv\\
		...
		Dann: $\alpha^*(\psi)=\psi\circ \alpha = 0$ $\Longrightarrow N$ nicht surjektiv!
		\end{enumerate}
      \stepcounter{enumi}
      \item Sei $N$ frei mit Basis $\{e_i,i \in I\}$.
            Sei $\beta: M \to M''$ surjektive $R$-lineare Abbildung und
            $\varphi: N \to M''$ $R$-linear. FÃ¼r jedes $i \in I$ sei $x_i \in M$
            ...
            \varphi(e_i)$ fÃ¼r alle $i \in I \Rightarrow \beta \circ \psi =
            \varphi$
      \item \label{1.5fBew}
            ...
            \mapsto x$ fÃ¼r alle $x \in X$ bestimmt ist. $\varphi$ ist surjektiv,
