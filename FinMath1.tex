...
\begin{definition}
Ein konvexes Risikomaß heißt kohärentes Risikomaß, falls es positiv homogen ist, d.h. $\forall \lambda\geq 0:\, \rho(\lambda X)=\lambda\cdot \rho (X)$.
\end{definition}
