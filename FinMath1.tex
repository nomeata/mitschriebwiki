...
\draw (0) -- (1) node[sloped,midway,above] {a};
\draw (0) -- (-1) node[sloped,midway,above] {bc};
\draw (1) -- (2);
\draw (1) -- (0') node[sloped,midway,above] {a};
\draw (-1) -- (0') node[sloped,midway,above] {b};
\draw (-1) -- (-2) node [sloped,midway,above] {c};
\draw (2) -- (3);
\draw (2) -- (1');
\draw (0') -- (1');
\draw (0') -- (-1') node[sloped,midway,above] {ab};
\draw (-2) -- (-1') node[sloped,midway,above] {c};
\draw (-2) -- (-3);
\end{tikzpicture}
\end{center}
