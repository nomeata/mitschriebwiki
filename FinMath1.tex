...
Wir betrachten das $T$-Perioden-CRR-Modell, das heißt wir betrachten den Zeithorizont $T$ und $t \in \{0, 1, \ldots,T\}$.
...
für $t=1, \ldots, T$.
 ...
 Bisher haben wir nur das Reale-Weltmaß $P$ definiert. Zur Optionsbewertung werden wir aber wir im Ein-Perioden-Modell ein risikoneutrales Maß $Q$ benötigen, dass wir analog zum obigen Vorgehen auf dem messbaren Raum $(\Omega, \cF)$ definieren:
\[
...
wobei $q=\frac{1+r-d}{u-d}$.
 \end{korollar}
 \begin{beweis}
 Es gilt $S_T=S_O \prod\limits_{k=1}^T Y_k$ mit $Q(Y_k=u)=q=1-Q(Y_k=d)$. Daher folgt aus Satz \ref{satz:2.4.5} sofort die Behauptung.
 \end{beweis}
