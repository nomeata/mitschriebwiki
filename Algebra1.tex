...
\sbew{
Nach Satz \ref{Satz 4} gibt es für jede Gruppe $G$ eine bijektive Abbildung $\alpha_G:F_X(G)=Abb(X,G) \to Hom(F(X),\cdot)$, $f\mapsto \varphi = \hat f$. Sei $\rho:G\to G'$ ein Gruppenhomomorphismus. Dann kommutiert:
\[\begin{CD}
