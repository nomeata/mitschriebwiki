...
$I \subsetneq J \subsetneq R \Leftrightarrow 0 \neq J+I \neq R/I$
}
\end{Bem}
...
\paragraph{1. Fall:} Sei $m=0$. Dann ist $c_k=a_k+b_0$ für $k=0,\ldots,n$ und \begin{align*}
...
Es ist $c\in R$, wenn: für $p\in \tilde{\mathcal P}$ ist nach \ref{nu-multiplikativ}
\[
